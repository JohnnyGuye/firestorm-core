...
import { CRUD_COLLECTION_REPO_TESTS, CRUD_DOCUMENT_REPO_TESTS, DECORATORS_TESTS, DERIVED_REPO_TESTS, INCLUDES_TESTS, RANDOM_PICK_TESTS } from "./test-groups"
...
export const MAIN_TEST_PLAN = new TestPlan(
    [
        ...
        INCLUDES_TESTS              .setIgnore(ignor  ),
        RANDOM_PICK_TESTS           .setIgnore(false  )
    ]
)
